...
Subjectively, our results seem quite reasonable for the given inputs.
Further improvement can be made to fix spurious edge segmentation in the future.
\begin{table}[H]
  \caption{Results of running our program on other images}
  \label{results}
  \centering
  \tabulinesep=0.3em
  \begin{tabu}to \textwidth{X[c,m]X[c,m]}
    ...
    Original & Result\\
    \midrule
    \includegraphics[height=18em]{{{Images/lena/lena_orig}}} & \includegraphics[height=18em]{{{Images/lena/lena_final}}} \\
    \includegraphics[height=18em]{{{Images/mandrill/mandrill_orig}}} & \includegraphics[height=18em]{{{Images/mandrill/mandrill_final}}} \\
    \includegraphics[height=18em]{{{Images/peppers/peppers_orig}}} & \includegraphics[height=18em]{{{Images/peppers/peppers_final}}} \\
    \bottomrule
  \end{tabu}
\end{table}
